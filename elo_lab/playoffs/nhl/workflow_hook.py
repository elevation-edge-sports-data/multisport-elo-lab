...
Drop-in usage after a call to simulate_season or inside a Monte Carlo loop:
    ...
    from elo_lab.playoffs.nhl.workflow_hook import run_playoffs_after_season
...
def run_playoffs_after_season(
    ...
    """
    Convert season-sim output → NHL playoff simulation in one call.
    ...
    return run_nhl_playoff_from_standings(
        standings=standings,
